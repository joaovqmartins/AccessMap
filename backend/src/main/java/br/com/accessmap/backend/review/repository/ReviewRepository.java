...
public interface ReviewRepository extends JpaRepository<Review, String> {
    ...
    List<Review> findByPlaceIdAndStatus(String placeId, ReviewStatus status);

    List<Review> findByUserIdAndStatus(String userId, ReviewStatus status);

    List<Review> findByUserIdAndPlaceIdAndStatus(String userId, String placeId, ReviewStatus status);
